...
import 'package:state_management/state_data.dart';
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        TextField(onChanged: (input) {
          newcity(input); //bunu ya bu şekilde yazarsın yada alttaki ile
          //Provider.of<StateData>(context, listen: false).newCity(input);
          //yukarıdakinde listenı false yapmazsan ekranda güncel yazıyı vermez
        })
      ]),
    );
  }
